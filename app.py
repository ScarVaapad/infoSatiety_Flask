...
schema = ['task_4', 'Personality', 'Demographic', 'tutorial_1', 'assignmentId', 'taskAccu', 'task_8', 'task_3', 'participantId', 'tutorial_2', 'task_5', 'minivlat_score', 'projectId', 'tutorial_3', 'task_6', 'totalDataUsed', 'task_1', 'task_2', 'userScores', 'Post_Task_Q', 'task_7', 'finalReward']
